...
package com.drawer.test.dialogs;
...
import com.drawer.test.views.ColorPickerPanelView;
import com.drawer.test.views.ColorPickerView;
            ...
            public boolean onEditorAction(TextView v, int actionId, KeyEvent event) {
                if (actionId == EditorInfo.IME_ACTION_DONE) {
                    ...
                    if (s.length() > 5 || s.length() < 10) {
                        try {
                            int c = Utils.convertToColorInt(s.toString());
